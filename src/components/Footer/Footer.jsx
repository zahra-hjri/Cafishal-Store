const Footer = () => {
  ...
  <li className="text-sm md:text-sm lg:text-md p-2 text-white">instagram</li>
    ...
    <li className="text-sm md:text-sm lg:text-md p-1 text-white">what's app</li>
    <li className="text-sm md:text-sm lg:text-md p-1 text-white">Twitter</li>
    <li className="text-sm md:text-sm lg:text-md p-1 text-white">zoom</li>
  </div>;
};
