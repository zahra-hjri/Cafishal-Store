const Footer = () => {
  ...
  <li className="text-sm md:text-sm lg:text-md p-3 text-gray-300 mt-2">insta</li>
    ...
    <li className="text-sm md:text-sm lg:text-md p-2 text-gray-300 mt-1">Twitter</li>
    <li className="text-sm md:text-sm lg:text-md p-2 text-gray-300 mt-1">discord</li>
  </div>;
};
